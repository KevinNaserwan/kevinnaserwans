...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building a School App With Laravel",
...
export const workExperience = [
  {
    id: 1,
    title: "Backend Engineer Intern - Suitmedia",
    desc:
      "Assisted in the development of a web-based platform using laravel, enhancing interactivity.",
    className: "md:col-span-2",
    thumbnail: "/exp1.svg",
  },
  {
    id: 2,
    title: "Backend Engineer - Meets Indonesia",
    desc:
      "Assisted in the development of a web-based platform using Golang And Next.js, enhancing interactivity.",
  ...
  {
    id: 4,
    title: "Fullstack Developer - Bujang Gadis Unsri",
    desc:
